...
## Project Structure
    ...
    ├── testapiautodatamod_108787  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_108787`
...
2. Clone this repo and `cd testapiautodatamod_108787`
